...
public class YuckExpandPropImpl extends YuckCompositeElementImpl implements YuckExpandProp {

  public YuckExpandPropImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YuckVisitor visitor) {
    visitor.visitExpandProp(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getExpandedprop() {
    return notNullChild(findChildByType(EXPANDEDPROP));
  }

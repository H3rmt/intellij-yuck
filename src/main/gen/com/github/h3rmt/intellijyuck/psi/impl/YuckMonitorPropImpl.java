...
public class YuckMonitorPropImpl extends YuckCompositeElementImpl implements YuckMonitorProp {

  public YuckMonitorPropImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YuckVisitor visitor) {
    visitor.visitMonitorProp(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getMonitorprop() {
    return notNullChild(findChildByType(MONITORPROP));
  }

...
public class YuckVexpandPropImpl extends YuckCompositeElementImpl implements YuckVexpandProp {

  public YuckVexpandPropImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YuckVisitor visitor) {
    visitor.visitVexpandProp(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getVexpandprop() {
    return notNullChild(findChildByType(VEXPANDPROP));
  }

...
public class YuckCssPropImpl extends YuckCompositeElementImpl implements YuckCssProp {

  public YuckCssPropImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YuckVisitor visitor) {
    visitor.visitCssProp(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getCssprop() {
    return notNullChild(findChildByType(CSSPROP));
  }

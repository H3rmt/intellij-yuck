...
public class YuckClassPropImpl extends YuckCompositeElementImpl implements YuckClassProp {

  public YuckClassPropImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YuckVisitor visitor) {
    visitor.visitClassProp(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getClassprop() {
    return notNullChild(findChildByType(CLASSPROP));
  }

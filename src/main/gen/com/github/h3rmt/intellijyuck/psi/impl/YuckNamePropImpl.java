...
public class YuckNamePropImpl extends YuckCompositeElementImpl implements YuckNameProp {

  public YuckNamePropImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YuckVisitor visitor) {
    visitor.visitNameProp(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getNameprop() {
    return notNullChild(findChildByType(NAMEPROP));
  }

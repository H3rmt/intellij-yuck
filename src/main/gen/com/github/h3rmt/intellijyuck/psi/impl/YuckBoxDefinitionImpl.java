...
public class YuckBoxDefinitionImpl extends YuckCompositeElementImpl implements YuckBoxDefinition {

  public YuckBoxDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YuckVisitor visitor) {
    visitor.visitBoxDefinition(this);
  }
  ...
  @Override
  @NotNull
  public List<YuckOrientationProp> getOrientationPropList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, YuckOrientationProp.class);
  }

  @Override
  @NotNull
  public List<YuckSpaceEvenlyProp> getSpaceEvenlyPropList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, YuckSpaceEvenlyProp.class);
  }

  @Override
  @NotNull
  public List<YuckSpacingProp> getSpacingPropList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, YuckSpacingProp.class);
  }

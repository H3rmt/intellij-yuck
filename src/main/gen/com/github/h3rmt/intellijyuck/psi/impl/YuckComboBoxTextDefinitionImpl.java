...
public class YuckComboBoxTextDefinitionImpl extends YuckCompositeElementImpl implements YuckComboBoxTextDefinition {
  ...
  public void accept(@NotNull YuckVisitor visitor) {
    visitor.visitComboBoxTextDefinition(this);
  }
  ...
  @Override
  @NotNull
  public List<YuckOnChangeProp> getOnChangePropList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, YuckOnChangeProp.class);
  }
  ...
  @Override
  @NotNull
  public List<YuckTimeoutProp> getTimeoutPropList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, YuckTimeoutProp.class);
  }
  ...
  @Override
  @NotNull
  public PsiElement getComboboxtext() {
    return notNullChild(findChildByType(COMBOBOXTEXT));
  }
